...
export const BusinessProfileSection = ({ company, onUpdate }: BusinessProfileSectionProps) => {
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <Accordion type="multiple" defaultValue={["basic", "contact", "bank", "social"]} className="w-full">
              {/* Basic Business Info */}
